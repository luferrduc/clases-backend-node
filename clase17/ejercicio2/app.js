...
const environment = async () => {
  try {
    await mongoose.connect(
      "mongodb+srv://lucianoferrando94:RxBWSWiQeU9Ic0Xy@cluster55575.ixldvmd.mongodb.net/clase17?retryWrites=true&w=majority"
    );
    ...
    const students = await studentsModel.paginate({}, { limit: 5, page: 1 })
